...
class TestCalculate(unittest.TestCase):
    ...
    def test_logaritmo_base10_method_returns_correct_result(self):
        self.assertAlmostEqual(1, self.calc.logaritmo_base10(10))
        self.assertAlmostEqual(2, self.calc.logaritmo_base10(100))
    
    def test_logaritmo_base10_fails_with_non_positive_parameter(self):
        self.assertRaises(ValueError, self.calc.logaritmo_base10, -1)
        self.assertRaises(ValueError, self.calc.logaritmo_base10, -100)
